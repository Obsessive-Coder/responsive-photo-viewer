...
setInterval(function() {
  ...
  if (screenWidth >= 980) {
    document.getElementById('responsive-image').style.backgroundImage = 'url("../images/980-' + 'index' + '.jpg")';
  ...
  if (screenWidth >= 768 && screenWidth <= 979) {
    document.getElementById('responsive-image').style.backgroundImage = 'url("../images/768-' + 'index' + '.jpg")';
  ...
  if (screenWidth <= 640) {
    document.getElementById('responsive-image').style.backgroundImage = 'url("../images/640-' + 'index' + '.jpg")';
