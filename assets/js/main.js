...
setInterval(function() {
  ...
  if (screenWidth >= 980) {
    document.getElementById('responsive-image').style.backgroundImage = 'url("assets/images/980-' + pageName + '.jpg")';
  ...
  if (screenWidth >= 768 && screenWidth <= 979) {
    document.getElementById('responsive-image').style.backgroundImage = 'url("assets/images/768-' + pageName + '.jpg")';
  ...
  if (screenWidth <= 640) {
    document.getElementById('responsive-image').style.backgroundImage = 'url("assets/images/640-' + pageName + '.jpg")';
